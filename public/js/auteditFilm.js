...
function openEditFilmModal(id, judul, sinopsis, trailer, id_negara, tahun_rilis, age_category, durasi, cast, genres, image) {
    ...
    document.getElementById('edit-film-form').action = `/author/film/${id}`;
