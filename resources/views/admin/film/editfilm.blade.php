            ...
            <form id="edit-film-form" class="p-4" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="cast" id="edit-cast"
                    ...
                    <!-- Input Banner Film -->
                    <div class=" col-span-2">
                        <label class="block text-sm font-medium">Banner Film</label>
                        <input type="file" id="edit-banner" name="banner" accept="image/*" class="w-full p-2 rounded" onchange="previewImage(this, 'edit-banner-preview')">
                        <img id="edit-banner-preview" src="" alt="Preview Banner" class="mt-2 w-40 rounded">
                    </div>
    
                    <!-- Input Banner Status -->
                    <div class="">
                        <label class="flex items-center">
                            <input type="checkbox" id="edit-banner-status" name="banner_status" value="1">
                            <span class="ml-2">Tampilkan di banner utama</span>
                        </label>
                    </div>
                </div>
