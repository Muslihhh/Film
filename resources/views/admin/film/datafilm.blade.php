<x-dashboard>
    <div class="relative h-full">
        ...
        <button data-modal-target="film-modal" data-modal-toggle="film-modal"
...
class="block mb-4 text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
type="button">Genre <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
...
@include('admin.film.filtergenre')
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border">
            <thead class="text-xs text-white uppercase bg-black dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">
                         <a href="{{ route('films.index', ['sort' => 'judul', 'order' => $sort === 'judul' && $order === 'asc' ? 'desc' : 'asc']) }}" class="flex">
                Judul
               
                    <span><svg class="w-4 h-4 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <th scope="col" class="px-6 py-3">
                        <a href="{{ route('films.index', ['sort' => 'rating', 'order' => $sort === 'rating' && $order === 'asc' ? 'desc' : 'asc']) }}" class="flex">
                            Rating
                    ...
                    <th scope="col" class="px-6 py-3">
                        <a href="{{ route('films.index', ['sort' => 'durasi', 'order' => $sort === 'durasi' && $order === 'asc' ? 'desc' : 'asc']) }}" class="flex">
                            Durasi
                    ...
                    <th scope="col" class="px-6 py-3">
                        <a href="{{ route('films.index', ['sort' => 'tahun_rilis', 'order' => $sort === 'tahun_rilis' && $order === 'asc' ? 'desc' : 'asc']) }}" class="flex">
                            Tahun Rilis
    ...
    @endif
                        ...
                        <td class="px-6 py-4 flex gap-2">
                            <button type="button"
    data-modal-target="edit-film-modal"
    data-modal-toggle="edit-film-modal"
    onclick="openEditFilmModal({{ $film->id }},
