<x-dasautor>
    <div class="relative h-full">
        <div class="mb-4">
            ...
            <form action="{{ route('film.index') }}" method="GET" class="flex items-center max-w-md mx-auto">
        ...
        @include('author.films.addfilm')
        @include('author.films.filtergenre')
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
            <thead class="text-xs text-white uppercase bg-black dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">
                        <a href="{{ route('film.index', ['sort' => 'judul', 'order' => $sort === 'judul' && $order === 'asc' ? 'desc' : 'asc']) }}"
                            class="flex">
                            Judul
                    ...
                    <th scope="col" class="px-6 py-3">
                        <a href="{{ route('film.index', ['sort' => 'rating', 'order' => $sort === 'rating' && $order === 'asc' ? 'desc' : 'asc']) }}"
                            class="flex">
                            Rating
                    ...
                    <th scope="col" class="px-6 py-3">
                        <a href="{{ route('film.index', ['sort' => 'durasi', 'order' => $sort === 'durasi' && $order === 'asc' ? 'desc' : 'asc']) }}"
                            class="flex">
                            Durasi
                    ...
                    <th scope="col" class="px-6 py-3">
                        <a href="{{ route('film.index', ['sort' => 'tahun_rilis', 'order' => $sort === 'tahun_rilis' && $order === 'asc' ? 'desc' : 'asc']) }}"
                            class="flex">
                            Tahun Rilis
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4 flex gap-2">
                            ...
                            <button type="button" data-modal-target="edit-film-modal"
                                ...
                                data-route="{{ route('film.update', $film->id) }}"
